...
if __name__ == "__main__":
    ...
    parser.add_argument('--alpha', type=int, default=10, help="the bigger the value of alpha the closer the reconstruction approaches to l1 loss")
    parser.add_argument('--lr', type=int, default=1e-3, help="learning rate")
    hparams = parser.parse_args()
    
    m = VAE(input_height=IMAGE_SIZE, latent_dim=hparams.latent_dim, kl_coeff=hparams.beta, alpha = hparams.alpha, lr=hparams.lr)
