'''
command usage:
python3 misc/book2/update_firestore.py -key "../key_probml_gcp.json" -csv misc/figures_url_mapping_book2.csv -level1 figures -level2 book2 -level3 figures
python3 misc/book2/update_firestore.py -key "../key_probml_gcp.json" -csv misc/non_figures_url_mapping_book2.csv -level1 figures -level2 book2 -level3 figures
'''
