...
flags.DEFINE_float("crop_size", default=128, help=("The dataset we are interested to train out vae on"))

flags.DEFINE_integer("batch_size", default=256, help=("Batch size for training."))

flags.DEFINE_integer("image_size", default=64, help=("Image size for training."))

flags.DEFINE_string("data_dir", default="kaggle", help=("Data directory for training."))
