...
pgm.add_node(daft.Node("S0", r"$\vS$", 1, 1, fixed=True))
pgm.add_node(daft.Node("v0", r"$\nu$", 1, 1.5, fixed=True))
pgm.add_node(daft.Node("k0", r"$\kappa$", 1, 2, fixed=True))
pgm.add_node(daft.Node("m0", r"$\vm$", 1, 2.5, fixed=True))

pgm.add_node(daft.Node("Lam_k", r"$\vLambda_k$", 3, 1))
pgm.add_node(daft.Node("mu_k", r"$\vmu_k$", 3, 2))

pgm.add_node(daft.Node("alpha0", r"$\valpha$", 1, 3, fixed=True))
