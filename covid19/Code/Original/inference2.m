function [para_post,theta] = inference2(M, pop, incidence, Iter, num_ens)

% This is Kevin Murphy's tweaked version of inference.m
% The differences are:
% -  I pass in arguments for the data, instead of loading from disk)
% - I pass in num IF iterations and number of ensemble members
% instead of hard-coding values.
% - I return the results as arguments, instead of saving to a file
% - I call initialize2.m instead of initialize, which passes in M
...
[x,paramax,paramin]=initialize2(pop0,num_ens,M);%get parameter range
