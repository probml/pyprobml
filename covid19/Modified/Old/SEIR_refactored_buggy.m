function [x_new, pop_new] = SEIR_new(x,M,pop,ts,pop0)
...
% This version includes a hack to match the original matlab code.
% After email correspoindence with the author, we confirmed the original
% code and paper had a bug. 
% See SEIR_original and SEIR_refactored for versions without the bug.
