...
function [z_locs_ens_times, p_ens_times] = helper(z_locs_ens_0, p_ens_0, ...
    mobility_locs_times, pop_locs, obs_truth_locs_times, obs_var_locs_times, inflation)
...
for t=1:num_times
    ...
    for l=1:num_loc
        ...
        [dz, dp] = compute_update_given_lt(z_locs_ens_t, p_ens_t, obs_pred_ens_lt, ...
            obs_truth_lt, obs_var_lt, nbrs);
